    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 pb-0">
          <h2 className="text-xl font-bold text-slate-800">Pago #{pago.id}</h2>
        ...
        <div className="p-6 space-y-4">
          ...
          {pago.estado_carga === "completo" && (
            <div className="border-t pt-4">
              <h3 className="text-sm font-semibold text-slate-700 mb-2">Factura / Recibo</h3>
              {pago.num_doc ? (
        ...
        <div className="flex justify-end gap-2 p-6 pt-0">
          <button onClick={onClose} className="px-4 py-2 rounded-lg bg-slate-100 text-slate-700 text-sm hover:bg-slate-200">
            Cerrar
          </button>
