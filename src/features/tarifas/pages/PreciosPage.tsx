        ...
        <table className="w-full text-[15px]">
          <thead>
            <tr className="bg-pine-900 text-khaki-100 font-label text-[13px] uppercase tracking-[0.08em]">
              <th className="px-3.5 py-2.5 text-left font-semibold">Días/sem</th>
              <th className="px-3.5 py-2.5 text-left font-semibold">Precio/mes</th>
              <th className="px-3.5 py-2.5 text-left font-semibold">% desc.</th>
              <th className="px-3.5 py-2.5 text-left font-semibold">Horas/sem</th>
            </tr>
          </thead>
          <tbody>
            {filas.map((f) => (
              <tr key={f.dias} className="odd:bg-white even:bg-khaki-100 border-t border-pine-900/10">
                <td className="px-3.5 py-2.5">{f.dias}</td>
                <td className="px-3.5 py-2.5 font-semibold text-pine-900">{f.precio}</td>
                <td className="px-3.5 py-2.5">{f.descuento}</td>
  ...
  return (
    <div>
      ...
      <Seccion n={2} titulo="Precios — Clases Grupo (1 alumno)">
        ...
        <p className="text-[14px] text-ink-soft italic mt-3">
      ...
      <Seccion n={7} titulo="Clases particulares para profesionales">
        ...
        <p className="text-[15px] font-semibold text-ink">Precio: 35€/hora.</p>
        <p className="text-[15px] text-ink mt-2">Antes de dar un precio cerrado, pedir: nivel actual, plazo/fecha límite, título o certificación que preparan, si usan libro propio, horario preferido, online o presencial.</p>
      </Seccion>
