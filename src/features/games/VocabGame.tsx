...
export default function VocabGame() {
      ...
      <div style={{
        ...
        <div style={{ maxWidth: "440px", width: "100%", textAlign: "center" }}>
          ...
          <div style={{ marginBottom: "2rem" }}>
            <p style={{ fontSize: "0.75rem", color: "var(--text-dim, #aaa)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "0.75rem" }}>
              Select level
            </p>
  ...
  if (screen === "result") {
    const pct = Math.round((score / (deck.length * 2)) * 100)
    const msg = pct >= 80 ? "Outstanding! 🌟" : pct >= 60 ? "Well done! 👏" : pct >= 40 ? "Good effort! 💪" : "Keep practising! 📚"
    return (
      <div style={{
        minHeight: "100vh",
        background: "var(--dark, #FAF8F5)",
  ...
  return (
    <div style={{
      ...
      {/* Header */}
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", maxWidth: "520px", margin: "0 auto 1rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div style={{
            ...
            height: "36px",
            borderRadius: "50%",
            border: `3px solid ${timeLeft <= 5 ? "#e53935" : "#B08D57"}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: "0.85rem",
            fontWeight: 600,
            color: timeLeft <= 5 ? "#e53935" : "var(--text, #1A1714)",
            transition: "all 0.3s",
          }}>
            {timeLeft}
          </div>
      ...
      {/* Progress bar */}
      <div style={{ maxWidth: "520px", margin: "0 auto 1.5rem", height: "3px", background: "rgba(0,0,0,0.08)", borderRadius: "999px" }}>
      ...
      <div style={{ maxWidth: "520px", margin: "0 auto" }}>
        <div style={{
          ...
          <div style={{
            ...
            background: LEVEL_COLORS[word.level] + "20",
          ...
          <p style={{ fontSize: "0.9rem", color: "var(--text-muted, #888)", lineHeight: 1.6 }}>
            {word.definition}
          </p>
        </div>
          ...
          {options.map((opt, idx) => {
            ...
            return (
              <button
                ...
                onMouseEnter={e => { if (!showFeedback) e.currentTarget.style.background = "#FAF8F5" }}
                onMouseLeave={e => { if (!showFeedback) e.currentTarget.style.background = "white" }}
              >
                {opt.word}
